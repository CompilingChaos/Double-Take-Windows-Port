...
// Legacy NTP receivers need enough lead for their receiver-initiated timing
// probe and userspace scheduling jitter. Keep the established port behavior
// while applying the newer per-media automatic latency policy.
